package com.sunnybear.library.recycler.adapter;
...
import com.sunnybear.library.recycler.animators.IAnimation;
import com.sunnybear.library.recycler.animators.ViewHelper;
import com.sunnybear.library.recycler.listener.OnItemClickListener;
import com.sunnybear.library.recycler.listener.OnItemLongClickListener;
...
//    public abstract void onBindItem(VH holder, Item item, int position);
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        mItemView = LayoutInflater.from(mContext).inflate(getLayoutId(viewType), parent, false);
